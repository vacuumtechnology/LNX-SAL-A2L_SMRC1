...
namespace Com.SharpZebra.Commands
{
    public class GraphicZebraCommand : IZebraCommand
    {
        ...
        public GraphicZebraCommand(Stream fileStream, int xPositionInDots, int yPositionInDots)
            : this(xPositionInDots, yPositionInDots, ImageFrom(fileStream))
        {
        ...
        public GraphicZebraCommand(string filename, int xPositionInDots, int yPositionInDots)
            : this(xPositionInDots, yPositionInDots, ImageFrom(filename))
        {
        }
