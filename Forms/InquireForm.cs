        ...
        private void buttonExportData_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                for (int irow = 0; irow < dataGridViewUUTRecords2.Rows.Count; irow++)
                {
                    ...
                    try
                    {
                        if (dataGridViewUUTRecords2.Rows[irow].Cells[0].Value != null)
                        {
                    ...
                    {
                        if (!String.IsNullOrWhiteSpace(strrow)) strrow += delimiter;
                        strrow += dataGridViewUUTRecords2.Rows[irow].Cells[icol].Value.ToString();
                    }
                    sw.WriteLine(strrow);
